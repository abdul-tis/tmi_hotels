...
?>
	...
	<div id="content">
		<div class="m-b-10">
           <div class="pull-left">
               <h3 class="pull-left">
                   <strong>Add Rate Category</strong>
               </h3>
           </div>
       </div>
                ...
                <div role="content">
                    ...
                    <div class="widget-body ">
                        <div class="tabbable">
                            ...
                            <form class="smart-form" id="addRateCategoryForm"  method="post" data-parsley-validate="" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/addRateCategory'); ?>">
                                                        ...
                                                        <fieldset>
                                                            <section>
                                                                ...
                                                                <label class="textarea">
                                                                    <textarea class="custom-scroll" rows="5" name="category_type" id="category_type" required=""><?php echo set_value('category_type');?></textarea>
                                                                </label>
                                                            </section>
                                                            <section>
                                                                <label class="label">Meal Plan</label>
                                                                <label class="input"> 
                                                                    <input type="text" placeholder="Meal Plan" required="" id="meal_plan" name="meal_plan" value="<?php echo set_value('meal_plan')?>">
                                                                </label>
                                                            </section>
                                                            <section>
...
<script type="text/javascript">
		...
		$(document).ready(function () {
			var instance = $('#addRateCategoryForm').parsley();
