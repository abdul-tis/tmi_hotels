                ...
                <div role="content">
                    ...
                    <div class="widget-body ">
                        <div class="tabbable">
                            ...
                            <form class="smart-form" id="addHotelChainForm"  method="post" data-parsley-validate="" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/addHotelChain'); ?>">
...
<script type="text/javascript">
		...
		$(document).ready(function () {
			var instance = $('#addHotelChainForm').parsley();
