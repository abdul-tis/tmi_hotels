                ...
                <div role="content">
                    ...
                    <div class="widget-body ">
                        <div class="tabbable">
                            ...
                            <form class="smart-form" id="addHotelTypeForm"  method="post" data-parsley-validate="" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/addHotelType'); ?>">
                                                    ...
                                                    <div class="col-lg-6 col-sm-6">
                                                        <fieldset>
                                                            <section>
                                                                ...
                                                                <label class="input"> 
                                                                    <input type="text" placeholder="Name" required="" id="hotel_type" name="hotel_type" value="<?php echo set_value('hotel_type')?>">
                                                                </label>
                                                            </section>
                                                            <section>
...
<script type="text/javascript">
		...
		$(document).ready(function () {
			var instance = $('#addHotelTypeForm').parsley();
