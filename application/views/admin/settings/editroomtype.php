                ...
                <div role="content">
                    ...
                    <div class="widget-body ">
                        <div class="tabbable">
                            ...
                            <form class="smart-form" id="editRoomTypeForm"  method="post" data-parsley-validate="" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/editRoomType/'.$room_type['id']); ?>">
                                                    ...
                                                    <div class="col-lg-6 col-sm-6">
                                                        <fieldset>
                                                            <section>
                                                                ...
                                                                <label class="input"> 
                                                                    <input type="text" placeholder="Room Type" required="" id="room_type" name="room_type" value="<?php echo (!empty($room_type['room_type']))?$room_type['room_type']:'';?>">
                                                                </label>
                                                            </section>
                                                            <section>
                                                                ...
                                                                <div class="input input-radio">
                                                                    <div class="col col-3">
                                                                        <label class="radio state-success">
                                                                            <input type="radio" <?php echo (!empty($room_type['status']) && $room_type['status'] == '1')?'checked':''?> value="1" name="status" data-parsley-multiple="status" data-parsley-id="1815">
                                                                            <i></i>Enable
                                                                        </label><ul class="parsley-errors-list" id="parsley-id-multiple-status"></ul>
                                                                        </div>
                                                                        <div class="col col-3">
                                                                        <label class="radio state-error">
                                                                            <input type="radio" <?php echo ($room_type['status'] !='' && $room_type['status'] == '0')?'checked':''?> value="0" name="status" data-parsley-multiple="status" data-parsley-id="1815">
                                                                            <i></i>Disable
                                                                        </label>
                                                                    </div>
                                                                </div>
...
<script type="text/javascript">
		...
		$(document).ready(function () {
			var instance = $('#editRoomTypeForm').parsley();
