                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover editable-seller-info" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr id="<?php echo $room_type['id'];?>" >
                                            <form class="editForm<?php echo $room_type['id'];?>" enctype="multipart/form-data">
                                            <td>
                                                <span class="view_mode<?php echo $room_type['id'];?>"><?php echo (!empty($room_type['room_type'])) ? $room_type['room_type'] : "N/A";?></span>
                                            </td>
                                            <td>
                                                <span class="view_mode<?php echo $room_type['id'];?>"><?php echo (!empty($status)) ? $status : "N/A";?></span>
                                            </td>
                                            <td>
                                                <a class="btn btn-success commonBtn" data-type ="edit" data-row-id="<?php echo 'room_'.$room_type['id'];?>" data-id="<?php echo $room_type['id'];?>" href="<?php echo base_url('admin/settings/editRoomType/'.$room_type['id'])?>">Edit</a>
                                                <a class="delete btn btn-sm btn-danger" data-target="#confirm-delete" data-toggle="modal" data-record-title="<?php echo $room_type['room_type'];?>" data-type="delete" data-record-id="<?php echo $room_type['id'];?>" data-remove-row="<?php echo 'room_'.$room_type['id'];?>" href="javascript:void(0)" >Delete</a>
                                            </td>
                                            </form>
                                        </tr>
                                        <?php } }?>
