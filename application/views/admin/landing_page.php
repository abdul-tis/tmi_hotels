...
<script src="<?php echo base_url(); ?>assets/admin/js/plugin/morris/raphael.min.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/js/plugin/morris/morris.min.js"></script>
