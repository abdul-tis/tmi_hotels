                ...
                <div role="content">
                    ...
                    <div class="widget-body ">
                        <div class="tabbable">
                            ...
                            <form class="smart-form" id="addGroupForm"  method="post" data-parsley-validate="" enctype="multipart/form-data" action="<?php echo base_url('admin/users/editGroup/'.$group->id); ?>">
                                                    ...
                                                    <div class="col-lg-6 col-sm-6">
                                                        <fieldset>
                                                            <section>
                                                                ...
                                                                <label class="input"> 
                                                                    <input type="text" placeholder="Name" required="" id="group_name" name="group_name" value="<?php echo $group->name?>" <?php echo ($this->config->item('admin_group', 'ion_auth') === $group->name) ? 'readonly' : '';?>>
                                                                </label>
                                                            </section>
                                                            <section>
                                                                <label class="label">Description</label>
                                                                <label class="input"> 
                                                                    <input type="text" placeholder="Description" required="" id="group_description" name="group_description" value="<?php echo $group->description;?>">
                                                                </label>
                                                            </section> 
                                                        </fieldset>
                                                    </div>
...
<script type="text/javascript">
		...
		$(document).ready(function () {
			var instance = $('#editGroupForm').parsley();
