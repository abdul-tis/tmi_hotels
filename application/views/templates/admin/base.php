...
<html lang="en-us">
    ...
    <body class="desktop-detected pace-done">
        ...
        <?php $this->load->view('themes/admin/side-menu'); ?>
	<div id="main" role="main">
		...
		<div class="row">
			...
			?>
						<div class="alert alert-<?=$message_type;?> fade in">
							...
							<i class="fa-fw fa fa-<?=$message_type;?> "></i>
							<strong><?php echo ucfirst($message_type);?></strong>
							<?=$message;?>
						</div>
			<?php } ?>
					</article>
       ...
       ?>
        ...
        <script src="<?php echo base_url(); ?>assets/admin/js/plugin/bootstrap-tags/bootstrap-tagsinput.min.js"></script>
