    ...
    bootstrap_alert.warning = function(message) {
			...
			html += '×</button><i class="fa-fw fa fa-warning "></i><strong>Warning</strong>';
			html += message+'</div>';
    ...
    bootstrap_alert.success = function(message) {
			...
			msghtml += '×</button><i class="fa-fw fa fa-check "></i><strong>Success </strong>';
			msghtml += message+'</div>';
      ...
      bootstrap_alert.danger = function(message) {
			...
			html += '×</button><i class="fa-fw fa fa-times "></i><strong>Error ! </strong>';
			html += message+'</div>';
            $('#show_alert_message').html(html)
